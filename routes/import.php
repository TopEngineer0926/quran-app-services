...
|
*/ // commented to provent any accidental executions
...
// Route::get('/verses', 'ImportController@verses')->name('import.verses');
...
// Route::get('/insert-translated-names', 'ImportController@insert_translated_names');
// Route::get('/insert-chapters-names', 'ImportController@insert_chapter_names');
